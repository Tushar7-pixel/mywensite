...
document.getElementById("open-ytu").addEventListener("click", () => {
    document.getElementById("to-open").classList.add("open-yt");
});

document.getElementById("shutdown").addEventListener("click", () => {
    document.getElementById("to-open").classList.remove("open-yt");
});
...
// image list
images[1] = "media/slider-1.jpg";
images[2] = "media/slider-2.jpg";
images[0] = "media/slider-3.jpg";
images[3] = "media/slider-4.jpg";
